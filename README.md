# CNS370: Secure user code execution with AWS Lambda for SaaS platforms
This repository lists the resources for the reInvent Chalk Talk: CNS370-Secure user code execution with AWS Lambda for SaaS platforms
